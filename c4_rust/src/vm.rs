...
impl VM {
    ...
    fn syscall_printf(&mut self) -> Result<i64, String> {
        // Get number of arguments to adjust the stack after call
        ...
        // In C4, the arguments are placed on the stack below sp
        // Format string is at sp + 0, first arg at sp + 1, etc.
        ...
        let mut arg_index = 1;  // Start with first arg after format string
